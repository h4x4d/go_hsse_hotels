...
type Room struct {
	...
	// Amount of person who can suit in number
	// Example: 3
	// Required: true
...
func (m *Room) Validate(formats strfmt.Registry) error {
	...
	if err := m.validatePersonCount(formats); err != nil {
		res = append(res, err)
	}
...
func (m *Room) validateCost(formats strfmt.Registry) error {
...
func (m *Room) validateHotelID(formats strfmt.Registry) error {
...
func (m *Room) validatePersonCount(formats strfmt.Registry) error {

	if err := validate.Required("person_count", "body", m.PersonCount); err != nil {
		return err
	}
...
func (m *Room) validateTags(formats strfmt.Registry) error {
...
func (m *Room) contextValidateTags(ctx context.Context, formats strfmt.Registry) error {
